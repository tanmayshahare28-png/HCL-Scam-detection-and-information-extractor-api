...
def generate_agent_response(text: str, session_id: str, scam_detected: bool,
    ...
    """
    Generate believable human-like response based on scam category and conversation context
    """
    ...
    # Generate response based on the detected scam category and conversation context
...
def home():
    return jsonify({
        "message": "Honeypot API - Expanded Scam Detection System",
        "version": "2.0.0",
        "status": "running",
...
if __name__ == "__main__":
    print("=" * 60)
    print("[ROCKET] HONEYPOT API - EXPANDED SCAM DETECTION SYSTEM")
    print("=" * 60)
