...
def generate_agent_response(text: str, session_id: str, scam_detected: bool,
    ...
    """
    Generate believable human-like response
    """
    ...
    # Scam engagement responses (act like a concerned user)
    engagement_responses = [
        ...
        # Playing along (extracting more info)
        "Okay, I'm concerned. What steps should I take?",
        "If I share my details, how do I know they're safe?",
        "What happens if I don't verify immediately?"
    ]

    # Choose response based on conversation stage
    stage = min(msg_count - 1, 3)  # 0-3 stages

    if stage == 0:
        return engagement_responses[0]  # Initial shock/concern
    elif stage == 1:
        return engagement_responses[3]  # Asking for verification method
    elif stage == 2:
        return engagement_responses[6]  # Showing hesitation
    else:
        return engagement_responses[9]  # Playing along
