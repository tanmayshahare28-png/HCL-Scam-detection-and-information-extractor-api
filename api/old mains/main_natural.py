...
def generate_basic_response_for_scam_type(message: str, conversation_context: List = [], session_id: str = "") -> str:
    """
    Generate a varied, more natural response based on the type of scam detected and conversation context
    """
...
def generate_agent_response(text: str, session_id: str, scam_detected: bool,
    ...
    """
    Generate more natural, varied human-like response based on scam category and conversation context
    """
...
def home():
    return jsonify({
        "message": "Honeypot API - Enhanced Natural Conversation System",
        "version": "2.5.0",
        "status": "running",
...
if __name__ == "__main__":
    print("=" * 60)
    print("[ROCKET] HONEYPOT API - ENHANCED NATURAL CONVERSATION SYSTEM")
    print("=" * 60)
    ...
    print("=" * 60)
    print("[LIBRARY] Enhanced scam detection with 12 categories:")
