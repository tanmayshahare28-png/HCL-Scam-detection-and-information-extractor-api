...
### Overview
This is a sophisticated honeypot API system with 13 specialized AI agents that detect and engage with different types of scammers. Each agent has unique personality traits and response patterns tailored to specific scam categories.
...
- **Fast Response Times**: Optimized for sub-50ms response times while maintaining intelligence
