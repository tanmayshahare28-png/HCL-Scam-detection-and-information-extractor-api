    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'extractedData' in data and data['scamDetected']:
                ...
                print(f"     ✓ Intelligence - URLs: {len(extracted.get('phishingLinks', []))}, UPI: {len(extracted.get('upiIds', []))}, Phones: {len(extracted.get('phoneNumbers', []))}, Banks: {len(extracted.get('bankAccounts', []))}")
